...
import { X, Mic, MicOff, Video, VideoOff, ScreenShare, PhoneOff, Users } from 'lucide-react'
...
export default function WorkshopSession({ workItemId, title, onClose }: { workItemId: string; title: string; onClose: () => void }) {
