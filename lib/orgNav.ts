import { Home, ClipboardCheck, Users, FileText, BookOpen, Presentation, LayoutDashboard, Briefcase, Search, Megaphone, HeartHandshake, Inbox, Building2 } from 'lucide-react'
...
// instead). Talent pools also held back off the visible nav for now
// (still a real route, just not linked yet) -- both parked
// deliberately, not oversights, per the corrected reference order:
// Feed, Discover, Jobs, Candidates, Inbox, Partners, Dashboard.
