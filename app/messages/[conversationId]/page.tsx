...
import { getMessages, sendMessage, markMessagesRead, supabase } from '@/lib/supabase'
          ...
          grouped.map(group => (
            <div key={group.date}>
              <div className="flex justify-center my-4">
                <span className="text-[#444] text-xs bg-[#1a1a1a] px-3 py-1 rounded-full">{formatDateSep(group.msgs[0].created_at)}</span>
              </div>
