...
export default function ChooseRolePage() {
  ...
  return (
    <AuthShell
      ...
      subtitle="Pick the option that describes you — each one leads somewhere different."
      onBack={() => router.push('/')}
      headerExtra={
    ...
    >
      {/* Each option is its own glass tile (not rows inside one shared
          card) -- two columns once there's room for them side by side,
          matching the reference's grid; still one stacked column on a
          phone-width screen. */}
